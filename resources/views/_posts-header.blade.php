            ...
            <div x-data="{ show: false }">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 rounded-xl mt-2 w-full z-50" style="display: none">
                    ...
                    @foreach ($categories as $category)
                        ...
                        <a href="{{ $category->slug }}" class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white">{{ $category->name }}</a>
                    @endforeach
                </div>
            </div>
