...
<body style="font-family: Open Sans, sans-serif">
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                @auth
                    ...
                    <x-dropdown>
                        ...
                        @admin
                        <x-dropdown-item href="/admin" class="{{ request()->is('admin') ? 'bg-blue-500 text-white' : '' }}">Dashboard</x-dropdown-item>
                        ...
                        <form
                            id="logout-form"
                            method="post" action="/logout" class="pl-6 text-xs font-semibold text-blue-500 hidden"
                            >
                            @csrf
                        </form>
                    </x-dropdown>
    ...
    @if ( session()->has('success') )
        ...
        <div
            ...
            x-show="show"
            class="bg-blue-500 text-white text-sm bottom-3 fixed font-white p-5 right-3 rounded-2xl"
        >
            <p>{{ session('success') }}</p>
        </div>
    @endif
